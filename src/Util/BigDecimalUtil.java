...
public class BigDecimalUtil {
    ...
    public static BigDecimal intRoot(BigDecimal x, long index, int scale) {
        ...
        do {
            ...
            BigDecimal numerator =
                    n.add(im1.multiply(xToI)).setScale(sp1, RoundingMode.HALF_EVEN);
    ...
    public static BigDecimal cosine(BigDecimal x) {
        ...
        while (lastVal.compareTo(currentValue) != 0) {
            ...
            BigDecimal term = numerator.divide(denominator, SCALE + 5, RoundingMode.HALF_EVEN);
    ...
    public static BigDecimal intPower(BigDecimal x, long exponent, int scale) {
        ...
        if (exponent < 0) {
            return BigDecimal.valueOf(1)
                    .divide(intPower(x, -exponent, scale), scale, RoundingMode.HALF_EVEN);
        }
    ...
    public static BigDecimal exp(BigDecimal x, int scale) {
        ...
        // If x is negative, return 1/(e^-x).
            ...
            return BigDecimal.valueOf(1)
                    .divide(exp(x.negate(), scale), scale, RoundingMode.HALF_EVEN);
        }
        ...
        BigDecimal z =
                BigDecimal.valueOf(1)
                        .add(xFraction.divide(xWhole, scale, RoundingMode.HALF_EVEN));
